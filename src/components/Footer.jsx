    ...
    return (
        <section className=" col-span-12">
            <div className="w-full h-32 border-t-2 border-slate-50 hidden md:flex">
                <ul className="w-full h-full flex justify-evenly items-center text-xs gap-x-20">
            ...
            <div className="w-full h-auto justify-between  pt-4 pb-24 md:pb-4 border-t-2 border-slate-50 md:px-16 flex">
                ...
                <div className="w-full md:w-auto px-4">
                    ...
                    <ul className="flex gap-4 mt-4">
                        <li className="w-24 h-24 border border-slate-500 flex justify-center items-center rounded-lg cursor-pointer" > <img src="https://my.uupload.ir/dl/v9pDZJQW" alt="rezi" className="w-12 h-20 object-cover " /></li>
                        <li className="w-24 h-24 border border-slate-500 flex justify-center items-center rounded-lg cursor-pointer" > <img src="https://my.uupload.ir/dl/n2vX7aWQ" alt="rezi" className="w-12 h-20 object-cover " /></li>
                        <li className="w-24 h-24 border border-slate-500 flex justify-center items-center rounded-lg cursor-pointer" ><img src="https://my.uupload.ir/dl/dxVXDybE" alt="rezi" className="w-12  h-20 object-cover " /></li>
