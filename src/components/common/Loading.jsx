...
export const HomeSkeleton = () => {
  return (
    <div className="w-full h-auto bg-white col-span-12 md:col-span-9 md:p-4 animate-pulse fadeShow">
...
export const ProductSkeleton = () => {
  return (
    <div className="h-[26rem] pb-4 bg-slate-200 rounded-xl mt-4 shadow-lg flex flex-col p-3 gap-4 animate-pulse fadeShow">
...
export const InterestSkeleton = () => {
  return (
    <div className="col-span-12 gap-4 h-[auto] bg-slate-100 p-5 grid grid-cols-12  relative md:gap-y-2  animate-pulse fadeShow">
...
export const CartLoading = () => {
  return (
    <div className="col-span-12 gap-4  p-5 grid grid-cols-12  relative md:gap-y-2 bg-slate-50 animate-pulse fadeShow">
      ...
      <div className="col-span-8 px-6 bg-slate-200 py-6 rounded-md flex flex-col md:pl-10 gap-4">
        ...
        <div className="md:w-64 w-44 h-6 bg-slate-300 rounded-lg"></div>
      </div>
...
export const SingleProductLoading = () => {
  return (
    <div className="col-span-12  h-auto md:h-[80vh]  relative grid grid-cols-12 md:grid-rows-12 bg-slate-100 md:py-2 md:px-6 rounded-lg items-center z-20 fadeShow">
      <div className="h-full col-span-12 md:col-span-7 lg:col-span-4 relative flex items-center flex-col justify-evenly z-30 ">
        <div className="flex justify-end absolute right-5 top-4 p-4 flex-col bg-slate-300 h-48 rounded-lg"></div>
        <div className="w-60 h-72 bg-slate-300 absolute top-4 right-20 rounded-lg"></div>
