...
const Navigation = () => {
  const { cart } = UseCart();
  return (
    <div className='w-full h-20 md:h-36 border-b-2 border-slate-100 flex flex-col justify-end'>
      <div>
        <header className='flex  w-full h-auto fixed top-0 z-50 bg-slate-200 '>
          ...
          <nav className='hidden w-full md:flex h-20 justify-between items-center border-b border-solid bg-white'>
            <div className='flex'>
