    ...
    return (
            <form className='w-full flex flex-col items-center text-sm gap-y-4'>
                <div className="w-full h-auto mt-4 flex flex-col  ">
                    ...
                    <input className=' outline-none  border px-4 py-2 mt-2 rounded-xl bg-white text-black' type="text" name='name' placeholder='نام خودرا وارد کنید ...' {...formik.getFieldProps('name')} />
                ...
                <div className="w-full h-auto mt-4 flex flex-col ">
                    ...
                    <input className='outline-none border px-4 py-2 mt-2 rounded-xl bg-white' type="tel" name='passwordConfirm' placeholder='رمزعبور خود را دوباره وارد کنید ...' {...formik.getFieldProps('passwordConfirm')} />
                    {formik.errors.password && formik.touched.password && (<div className='text-red-400 mt-2 ml-4'>{formik.errors.password}</div>)}
                </div>
