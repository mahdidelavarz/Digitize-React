...
const BurgerMenu = ({ burgerActive, handleBurger }) => {
  return (
    <div className="bg-slate-300 ">
      <div className={`w-[55vw] h-full bg-slate-300 transition-all duration-500 absolute top-0 right-0 rounded-md bg-opacity-100 ${burgerActive && 'translate-x-96 hidden'} `}>
        {/* ---------------------- header of the menu ------------------------------- */}
