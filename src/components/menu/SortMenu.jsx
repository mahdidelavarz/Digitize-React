    ...
    <div className="hidden md:flex bg-white col-span-9 rounded-md justify-center items-center p-4 h-16">
      ...
      <ul className="w-full flex gap-10  ">
        <li
          ...
          className="text-slate-400 hover:text-slate-700 transition-all duration-300 text-bold text-xs lg:text-base cursor-pointer"
        >
          محبوب ترین محصول
        </li>
        <li
          onClick={() => handleFilter("exp")}
          className="text-slate-400 hover:text-slate-700 transition-all duration-300 text-xs lg:text-base cursor-pointer"
        >
          گران ترین محصول
        </li>
        <li
