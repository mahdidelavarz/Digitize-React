      ...
      {loading ? (
        <section className="col-span-12 h-auto  relative grid grid-cols-12 md:grid-rows-12 bg-white py-2  px-4 rounded-lg items-center z-20 ">
          ...
          <div className="h-full col-span-12 md:col-span-7 lg:col-span-4 relative flex items-center flex-col justify-evenly z-30">
            <div className="flex justify-end absolute right-[-15px] top-0 p-4 flex-col ">
              {checkInInterestList(interestList, product) ? (
                ...
                <AiOutlineHeart
                  onClick={handleLike}
                  className="ml-5 text-2xl text-indigo-900 hover:text-rose-500 cursor-pointer transition-all duration-300"
                />
              )}
            ...
            <div className="lg:flex mt-4 hidden col-span-4 p-4">
              <div className="w-1/3 p-2 border-2 border-slate-400 m-1 rounded-md cursor-pointer object-cover ">
                {" "}
                <img
          ...
          <div className="col-span-12  md:col-span-5 lg:col-span-5  flex flex-col md:h-full md:justify-evenly px-8">
            <h1 className=" text-base mt-8 md:text-base text-slate-500">
              {product.name}
            </h1>
            <h1 className="text-xl mt-2 md:text-base text-slate-500">
              {product.nameF}
            </h1>
            <div className="mt-8">
            ...
            {/* <!-- !...................................Attributes  (mobile)............................................... --> */}
            <div className="w-full h-auto flex flex-col items-end mt-7 p-2  overflow-hidden mb-4 rounded-md lg:hidden border-2 border-solid">
              <span className="mb-3 bold text-base text-slate-900 flex justify-start w-full">
                ویژگی های کالا :
              </span>
              <div className="w-full flex relative  flex-col">
                <div className="w-3 h-3 rounded-full bg-red-500 top-1 right-8 absolute "></div>
                <span className="flex px-2 text-slate-900 mr-10 justify-start">
                  {" "}
                  حافظه داخلی :{" "}
                </span>
                ...
                <div className="w-3 h-3 rounded-full bg-red-500 top-[4.3rem] absolute right-8"></div>
                <span className="flex px-2 text-slate-900 mr-10 justify-start">
                  {" "}
                  حافظه رم :{" "}
                </span>
                ...
                <div className="w-3 h-3 rounded-full bg-red-500 top-[8.4rem] absolute right-8"></div>
                <span className="flex px-2 text-slate-900 mr-10 justify-start">
                  {" "}
                ...
                <div className="w-3 h-3 rounded-full bg-red-500 top-[12.4rem] absolute right-8"></div>
                <span className="flex px-2 text-slate-900 mr-10 justify-start">
                  {" "}
                  شبکه های ارتباطی :
                </span>
            ...
            <div className="w-60 h-auto bg-white lg:flex flex-col mt-5 overflow-hidden mb-4 rounded-md col-span-2 lg:text-sm hidden items-center">
              ...
              <div className="w-full flex relative mr-5 flex-col">
                ...
                <span className="flex px-2 text-slate-900 mr-5 justify-start">
                  {" "}
                  حافظه داخلی :{" "}
                </span>
          ...
          {/* ------------------------------add to cart div--------------------- */}
          <div className="h-full col-span-12 lg:col-span-3 flex flex-col items-center md:px-6 md:bg-slate-100 py-4 rounded-xl justify-between ">
            <div className="w-full flex relative ">
              ...
              <div className="w-full mt-2 mr-2 flex justify-between">
                <span className="lg:text-sm xl:text-base"> گارانتی:</span>{" "}
                <span className="text-slate-500 lg:text-sm xl:text-base">
                  {" "}
                  18 ماه زرین خدمت
                </span>
              </div>
            ...
            <div className="w-full flex relative mt-4">
              ...
              <div className="w-full mt-2 mr-2 flex justify-between">
                <span className=" mr-2 lg:text-sm xl:text-base">
                  {" "}
                  فروشنده :
                </span>{" "}
                <span className="text-slate-500 lg:text-sm xl:text-base">
            ...
            <div className="fixed w-full h-[4.3rem] bg-slate-100 bottom-2 rounded-3xl  p-3 z-50 md:hidden">
              <div className="w-full h-full flex justify-between items-center px-10 rounded-2xl bg-rose-600">
                ...
                <span className="text-white  w-auto  text-xl lg:text-base xl:text-lg">
            ...
            <div className="w-full md:flex flex-col justify-end items-end mt-6 static  bg-slate-100 z-30 hidden ">
              <span className="text-rose-700  w-auto  text-xl lg:text-base xl:text-lg">
                {product.price.toLocaleString("fa-IR")} تومان
              </span>
              <button
                onClick={() => handleAddToCart(product)}
                className="  w-full py-2  bg-rose-500 rounded-md mt-2  text-white  lg:text-base text-lg"
              >
                {checkInCart(cart, product)
