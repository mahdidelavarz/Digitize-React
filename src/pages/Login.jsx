...
const Login = () => {
    ...
    return (
        <div className="w-full h-[100vh] bg-login-page flex justify-center items-center">
            <form className='w-[75vw] md:w-[60vw] lg:w-[34vw] h-[80vh] bg-gradient-to-r from-blue-800 to-purple-800 rounded-2xl py-4 px-10 flex flex-col items-center'>
                <div className='w-full p-4 flex justify-center'>
                    <span className='font-extrabold text-4xl text-white'>Login</span>
                </div>
                ...
                <button type='submit' className='w-80 py-2 text-white bg-gradient-to-r from-blue-200 to-purple-600 mt-10 rounded-xl' onClick={formik.handleSubmit}>Login</button>
