    ...
    <div className="w-full h-[100vh] bg-white">
      <div className="w-full h-[90%] p-4">
        <div className="w-full h-16 bg-slate-300 rounded-full flex justify-between items-center px-6 text-slate-700">
         ...
         <Link to='/'> <BiLeftArrowAlt className="text-2xl cursor-pointer" /></Link>
        </div>
        <div className="w-full h-[85%] border border-solid mt-2 rounded-2xl border-slate-400 relative ">
          <div className="w-full h-[85%] flex flex-col gap-4 p-6">
          ...
          <div className="flex w-full h-16 absolute bottom-0 bg-slate-300 rounded-b-2xl justify-between items-center px-5 gap-4">
            <BsFillSendFill
